...
export const Instagram = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <g fill="#FFF">
      ...
      <path d="M257.2 176.2c-43.4 0-78.4 35.7-78.4 79.8s35.1 79.8 78.4 79.8 78.4-35.7 78.4-79.8-35.1-79.8-78.4-79.8zm0 131.6c-28.1 0-50.9-23.1-50.9-51.8s22.8-51.8 50.9-51.8 50.9 23.1 50.9 51.8c0 28.7-22.8 51.8-50.9 51.8z" />
